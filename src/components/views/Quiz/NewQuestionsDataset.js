...
export const NewQuestionsDataset = [
  ...
  {
    question:
      'Which of the following are important considerations when motivating a team?',
    order: 5,
    type: 'influencer',
    answers: [
      {
  ...
  {
    question:
      'If I need to pivot my idea early on, I did not carry out the correct research',
    order: 15,
    type: 'customerInsight',
    answers: [
      {
  ...
  {
    question: 'A great product should be driven by one unique customer insight',
    order: 16,
    type: 'customerInsight',
    answers: [
      {
  ...
  {
    question:
      'Managing my ability to stay objective & to persist when assessing an opportunity is as important as using the most up-to-date frameworks & processes',
    order: 17,
    type: 'influencer',
    answers: [
      {
  ...
  {
    question: 'I can objectively determine when to pivot or persist ',
    order: 18,
    type: 'influencer',
    answers: [
      {
  ...
  {
    question: 'Defining product vision is key before defining my solution',
    order: 19,
    type: 'productStrategy',
    answers: [
      {
