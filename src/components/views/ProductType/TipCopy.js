  ...
  productStrategy: {
    tip: (
      <p>
        ...
        business{"'"} problems - is your superpower. Strategists are equal parts
        confident and decisive, and you{"'"}ve got both in bucket loads.
        Awesome!{' '}
      </p>
    ),
  },
  ...
  influencer: {
    tip: (
      <p>
        ...
        strategy to make sure it gets done. You bring out the best in all those
        around you and are a force to be reckoned with. Awesome!{' '}
      </p>
    ),
  },
  customerInsight: {
    tip: (
      <p>
        ...
        the tenacity to see it through. You{"'"}re confident and aren{"'"}t
        fazed by new challenges. Bring it on!{' '}
      </p>
    ),
  },
  allRounder: {
